...
export function PortfolioHeader() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-40 h-[var(--header-h)] border-b border-[var(--hero-border)] bg-[var(--hero-bg)]">
      <div className="mx-auto flex h-full w-full items-center justify-between px-6 md:px-10 xl:px-16">
        ...
        >
          <Link href="/" className="flex items-center gap-3">
            <span className="text-xl uppercase tracking-[0.4em] text-[var(--hero-accent)]">
              {t('NAV.BRAND.001')}
            </span>
          </Link>
        </Button>

        <nav className="hidden items-center gap-8 text-md uppercase tracking-[0.3em] text-[var(--hero-muted)] md:flex">
          <Link
            href="/"
